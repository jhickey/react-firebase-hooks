...
export declare const useListVals: <T, KeyField extends string = "", RefField extends string = "">(query?: firebase.database.Query | null | undefined, options?: ValOptions | undefined) => [Val<T, KeyField, RefField>[] | undefined, boolean, firebase.FirebaseError | undefined];
