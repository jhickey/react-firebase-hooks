...
var snapshotToData = function (snapshot, idField, refField) {
    if (!snapshot.exists) {
        return undefined;
    }
    return __assign({}, snapshot.data(), (idField ? (_a = {}, _a[idField] = snapshot.id, _a) : null), (refField ? (_b = {}, _b[refField] = snapshot.ref, _b) : null));
    var _a, _b;
};
    ...
    var values = react.useMemo(function () {
        return (snapshots
            ? snapshots.docs.map(function (doc) {
                return snapshotToData(doc, idField, refField);
            })
            : undefined);
